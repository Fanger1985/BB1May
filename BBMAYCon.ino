...
void setup() {
    ...
    // Define your network SSID and password for the AP mode
    const char* ap_ssid = "BB1";
    const char* ap_password = "jilakee"; // Use a strong password in production
    ...
    // Setup Hall sensor pins and attach interrupts
    ...
    // Initial delay before operations
